...
def load_source_defaults() -> dict[str, Any]:
    ...
    env_map = {
        ...
        "cloudmail_admin_email": "GROK_REGISTER_DEFAULT_CLOUDMAIL_ADMIN_EMAIL",
    }
...
def build_task_config(payload: TaskCreate) -> dict[str, Any]:
    ...
    return {
        ...
        "temp_mail_provider": defaults.get("temp_mail_provider", ""),
        "cloudmail_admin_email": defaults.get("cloudmail_admin_email", ""),
        "api": {
