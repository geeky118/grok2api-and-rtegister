# grok2api-python-stack

This stack packages the Python `grok2api` service with the `grok-register`
console, worker runtime, WARP routing, and deployment overrides used by the
server deployment.
